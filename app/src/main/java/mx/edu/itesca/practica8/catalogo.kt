...
class Catalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridSeries: GridView = findViewById(R.id.mserie_catalogo)
...
class PeliculaAdapter : BaseAdapter {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.pelicula, null)
            viewHolder = ViewHolder()
            viewHolder.imagen = view.findViewById(R.id.image_movie_call)
            viewHolder.titulo = view.findViewById(R.id.movie_title_cell)
            view.tag = viewHolder
        } else {
        ...
        viewHolder.imagen?.setImageResource(pelicula.image)
        viewHolder.titulo?.text = pelicula.titulo

        viewHolder.imagen?.setOnClickListener {
            context?.let {
                val intent = Intent(it, detalle_pelicula::class.java)
